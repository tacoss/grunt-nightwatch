module.exports = function(grunt) {
  grunt.registerTask('nightwatch', 'Run your Nightwatch.js tests', function(target) {
    ...
    settings.test_settings[group] = $.mergeVars(settings.test_settings.default, settings.test_settings[group], defaults.test_settings, options.test_settings, _.pick(options[group] || {}, settings_opts));
